...
<div class='large-10 columns'>
	<form method='POST' action='/labmgr/start_vms_by_classroom'>
	<div class='row'>
		<div class='small-4 small-centered columns'>
			<br>
			<input type='submit' class='button large center' value='Start VMs'>
			<br>
			<input type='radio' checked name='start_vm_option' value='start_vm'><label>Start</label>
			<input type='radio' name='start_vm_option' value='revert_vm'><label>Revert</label>
			<input type='radio' name='start_vm_option' value='revert_start_vm'><label>Revert & Start</label>
		</div>
	</div>
