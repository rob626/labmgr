		...
		<div class='large-6 columns'>
			...
			<?php
				...
				foreach($torrents as $torrent) {
					...
					echo "<input type='checkbox' class='checkbox' name='torrent_ids[]' value='".$torrent['torrent_id']."'><label>".$torrent['name']." - v".$torrent['torrent_version']."&nbsp &nbsp (".$torrent['create_timestamp'].")</label><br>";
				}
			?>
		</div>
